...
# Parsing Script – wemos_temphum001 - Rev. A

This **Parsing** script is designed for the **wemos_temphum001** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing – wemos_temphum001 Rev. A

Este script de **Parsing** está diseñado para el modelo **wemos_temphum001** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
